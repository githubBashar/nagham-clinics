        ...
        <div className="mt-16 grid gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="flex flex-col gap-8">
            ...
            <Reveal delay={0.08}>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-sm font-bold uppercase tracking-[0.18em] text-gold">{t.contact.phoneLabel}</h3>
                  <div className="mt-2 flex flex-col gap-1.5">
                    {CLINIC.phones.map((p, i) => (
                      <a
                        key={p}
                        href={`tel:${CLINIC.phonesIntl[i]}`}
                        className="nums-latin w-fit text-lg font-semibold tracking-wide text-ivory transition-colors hover:text-gold"
                        dir="ltr"
                      >
                        {p}
                      </a>
            ...
            <Reveal delay={0.24}>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2.5 rounded-full bg-gold px-8 py-4 text-sm font-bold text-forest transition-all duration-200 hover:scale-[1.03] hover:bg-gold-light"
              >
          ...
          <Reveal delay={0.1}>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group relative flex aspect-[4/3] flex-col items-center justify-center gap-4 overflow-hidden rounded-2xl border border-gold/25 bg-ivory lg:aspect-auto lg:h-full lg:min-h-[380px]"
            >
              ...
              <div className="relative flex flex-col items-center gap-3 text-center">
                <span className="flex h-14 w-14 items-center justify-center rounded-full bg-forest shadow-lg transition-transform duration-300 group-hover:scale-110">
